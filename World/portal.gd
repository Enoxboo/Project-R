...
func _on_area_entered(area: Area2D) -> void:
	...
	if is_demo:
		...
		print("res://Levels/Demo/" + target_scene + "_" + str(GameData.next_room) + ".tscn")
		get_tree().call_deferred("change_scene_to_file", "res://Levels/Demo/" + target_scene + "_" + str(GameData.next_room) + ".tscn")
	elif target_scene == "hub":
