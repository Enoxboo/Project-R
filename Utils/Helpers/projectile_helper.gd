...
static func throw(parent, sprite, size, speed, time, is_ally, layer_type: int, masks: Array, damage, stun, element, destruct_on_hit):
	...
	proj.destruct_on_hit = destruct_on_hit
